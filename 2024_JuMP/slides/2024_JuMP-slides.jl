...
# ╔═╡ 3ab032f2-0352-420f-9486-c66d79e5bf8c
using Pkg

# ╔═╡ abbfabe2-9f2c-4911-bb97-067ac7de8ce5
pkg"dev /home/blegat/.julia/dev/BibInternal/"

# ╔═╡ 5dd90313-98f8-47b3-a216-97a78822674f
using PlutoUI, Luxor

# ╔═╡ e6497d5d-2302-4f88-9686-14d990c3ed3b
include("utils.jl")

# ╔═╡ 474b4512-7daa-41e0-a2ac-3dedb1397fa3
md"""# Why you should stop using the monomial basis

*Benoît Legat*, *Bart De Moor* in $(img("kuleuven.png", :height => 20)) supported by $(img("erc.png", :height => 20)) grant n°885682 "Back to the roots"
"""

# ╔═╡ 44f50b8f-148f-491f-ad5d-5a47d67e584e
Cols((
	md"""
	Joint work with *Marek Kaluba* and *Tillmann Weisser* $(img("marek_tillmann.png"))
	""",
	html"  ",
	md"""
$(img("JuMP.png", :height => 50))
	""",
), [50, 20, 30])

# ╔═╡ 6c0a0cf5-5320-4014-812e-69f8403cef7d
frametitle("Chebyshev basis")

# ╔═╡ 80c6150e-6037-4c5f-890d-96ccdf81c125
bib(["dumitrescu2017Positive"])

# ╔═╡ 9a865922-8ec5-4e4f-96f6-5f29bdebe4e9
frametitle("Univariate trigonometric basis and FFT")

# ╔═╡ c51a8c55-3b9b-4e5b-a784-528b7870a822
bib(["dumitrescu2017Positive", "legat2023lowrank"])

# ╔═╡ d1895efa-3657-414a-b459-ea208d01a4d3
frametitle("Sampling basis and Hypatia")

# ╔═╡ ba4139ab-bc8b-4a0a-a44d-222d41cba4e3
frametitle("Sampling basis and rank 1 constraint")
...
# ╔═╡ 9f3ed294-fb12-4688-811f-47e283103db9
md"See https://github.com/Humans-of-Julia/BibInternal.jl/pull/25"
...
manifest_format = "2.0"
project_hash = "52330d1d56bf1bd39ebd045563a802761cef9510"
...
[[deps.BibInternal]]
path = "/home/blegat/.julia/dev/BibInternal/"
