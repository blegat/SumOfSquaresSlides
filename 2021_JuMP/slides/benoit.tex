...
\begin{frame}{Schur lemma}
  ...
  \noindent {\tiny Sagan, \emph{The symmetric group}, Springer Science \& Business Media, 2001: Definition~1.4.5, Definition~1.6.2, Example~1.7.2, Example~1.7.3 (adapted from $\mathbb{C}^{n \times n}$ to symmetric matrices $\SymK \subseteq \mathbb{R}^{n \times n}$)}
\end{frame}
